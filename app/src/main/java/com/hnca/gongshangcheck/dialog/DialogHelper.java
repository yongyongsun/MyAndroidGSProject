package com.hnca.gongshangcheck.dialog;
...
public class DialogHelper implements DialogInterface.OnCancelListener {
     ...
     * @param confirmDataListener 确认按钮点击回调
     * @param cancelListener  取消按钮点击回调
     */
    public void showConfirmDataDialog(String message,
                                  String confirmText,
                                  String cancelText,
                                  final OnDialogConfirmDataListener confirmDataListener,
